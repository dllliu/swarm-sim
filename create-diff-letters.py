...
class Simulation:
    ...
    def run(self):
        ...
        letter_index = 0 # NOTE this letter will start from A, change this index to start from another letter
        ...
        while running:
            ...
            if dt % 100 == 0 and dt != 0: # NOTE ran each letter simulation for 100 timesteps
                if letter_index <= 24:
